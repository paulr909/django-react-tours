...
class WishListItemViewSet(viewsets.ViewSet):
    ...
    def destroy(self, request, pk=None):
        ...
        return Response("Item removed from wish list", status=200)
    ...
    def partial_update(self, request, pk=None):
        try:
            ...
            item.save()
            message = "Item fields {} were updated".format(
                ",".join(request.data.keys())
            )
        except WishListItem.DoesNotExist:
            message = "Item was not in wish list"
    ...
    def list(self, request):
        ...
        package_ids = cache.get_or_set(
            "wish-list:{}".format(self.session_id), get_package_ids
        )
    ...
    def create(self, request):
        ...
        cache.delete("wish-list:{}".format(self.session_id))
        return Response("Item added to wish list", status=200)
